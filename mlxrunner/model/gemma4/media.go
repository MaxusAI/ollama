...
var (
	...
	_ model.MediaBudgetModel = (*Model)(nil)
)
...
// PrepareMedia implements model.MediaModel with gemma4's default budget. The
...
// PrepareMediaWithBudget implements model.MediaBudgetModel: splice each image
...
// EncodeMedia implements model.MediaModel: run the vision path over one prepared
