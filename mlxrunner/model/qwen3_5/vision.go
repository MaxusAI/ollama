...
// PrepareMediaWithBudget implements model.MediaBudgetModel. qwen3.5 keeps its own
...
func (m *Model) PrepareMediaWithBudget(segments []model.Segment, imageMinTokens, imageMaxTokens int) (*model.PreparedRequest, error) {
	...
	minTokens, maxTokens := model.ResolveImageBudget(imageMinTokens, imageMaxTokens, 0, 0)
