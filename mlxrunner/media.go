...
func (r *Runner) expandMedia(mm model.MediaModel, prompt string, media []llm.MediaData, imageMinTokens, imageMaxTokens int) (*model.PreparedRequest, []mediaItem, error) {
	...
	var err error
	if bm, ok := mm.(model.MediaBudgetModel); ok {
