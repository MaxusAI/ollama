...
Supported backend values are `cuda_v12`, `cuda_v13`, `rocm_v7_1`, `rocm_v10_0`, `vulkan`, `cuda_jetpack5`, and `cuda_jetpack6`.
...
# ROCm / HIP
cmake -B build . -DOLLAMA_LLAMA_BACKENDS=rocm_v10_0 -DCMAKE_HIP_ARCHITECTURES=gfx1100
```
