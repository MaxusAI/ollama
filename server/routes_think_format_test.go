...
func TestThinkFormatSinglePass(t *testing.T) {
	// Single pass is v0.34.4's default; pin it so an ambient
	// OLLAMA_FORMAT_TWO_PASS=1 (the ADR 0004 rollback) cannot change what this tests.
	t.Setenv("OLLAMA_FORMAT_TWO_PASS", "")
